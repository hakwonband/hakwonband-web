...
public class CrossDomainFilter implements Filter {
	 ...
	 * 크로스 도메인 리스트
	 */
	private static final List<String> crossDomainList = CommonConfig.getList("api/crossDomain");
	...
	public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain chain) throws IOException, ServletException {
		...
		response.addHeader("Access-Control-Allow-Headers", "Access-Control-Request-Method, Access-Control-Request-Headers, X-PINGOTHER, Origin, X-Requested-With, Content-Type, Accept");
