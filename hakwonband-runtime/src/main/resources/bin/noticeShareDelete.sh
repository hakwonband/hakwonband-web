...
RUNNTIME_HOME=/hakwon-band/source/hakwon-runtime/noticeShareDelete
...
CLASSPATH=$CLASSPATH:$RUNNTIME_HOME/lib/hakwonband-core-0.0.1-20150829-01.jar
...
CLASSPATH=$CLASSPATH:$RUNNTIME_HOME/lib/jackson-annotations-2.2.2.jar
CLASSPATH=$CLASSPATH:$RUNNTIME_HOME/lib/jackson-core-2.2.2.jar
CLASSPATH=$CLASSPATH:$RUNNTIME_HOME/lib/jackson-core-asl-1.9.13.jar
CLASSPATH=$CLASSPATH:$RUNNTIME_HOME/lib/jackson-databind-2.2.2.jar
...
CLASSPATH=$CLASSPATH:$RUNNTIME_HOME/lib/log4j-1.2.14.jar
...
CLASSPATH=$CLASSPATH:$RUNNTIME_HOME/lib/slf4j-api-1.7.5.jar
...
SERVER_TYPE=$1
SERVICE_NAME="noticeShareDelete"
...
java $USER_OPTS_ARGS hakwonband.runtime.main.NoticeShareDeleteMain > $NOHUP_LOG_FILE &