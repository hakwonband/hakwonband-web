package hakwonband.mobile.common.constant;
...
public class HakwonConstant {
	...
	public static class PageScale {
		...
		public static final int HAKWON_REQ			= 30;	// 학원 요청
		public static final int CLASS_REQ			= 6;	// 학원내 반 목록 요청
		public static final int MESSAGE_REQ			= 10;	// 메세지 요청
		public static final int NOTICE_REQ			= 10;	// 공지사항 요청
		public static final int EVENT_REQ			= 10;	// 이벤트 요청
		public static final int MESSAGE_REQ_TOP3	= 3;	// 상위 데이터 3개
	}
