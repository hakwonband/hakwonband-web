...
var commProto = {
	 ...
	 * @returns
	 *
	 * usage : commProto.replaceURLWithHTMLLinks
	 */
	replaceURLWithHTMLLinks : function(text) {
		var exp = /(\b(https?|ftp|file):\/\/[-A-Z0-9+&@#\/%?=~_|!:,.;]*[-A-Z0-9+&@#\/%=~_|])/ig;
		return text.replace(exp, '<a href="$1" class="a_link" target="_blank">$1</a>');
	}
	...
	/**
	 * 이메일 주소 체크
	 * commProto.checkEmailValidation
	 */
...
/*	윤년 일 카운트	*/
function getMoonDays(year, month) {
	year = parseInt(year);
