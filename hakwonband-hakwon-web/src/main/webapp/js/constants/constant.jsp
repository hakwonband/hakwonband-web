...
var tinymceConst = {
	...
	, toolbar_pcweb : 'fontselect fontsizeselect | bold italic underline strikethrough forecolor backcolor '
		+'| alignleft aligncenter alignright alignjustify | styleselect | bullist numlist | link charmap emoticons | fullscreen | code '
	, toolbar_mobile : 'bold strikethrough forecolor backcolor alignleft aligncenter alignright alignjustify | '
...
tinymceConst.initOptios = {
	...
	, toolbar1: tinymceConst.<%=isMobile==true?"toolbar_mobile":"toolbar_pcweb"%>
	, object_resizing : 'img'
	...
	, contextmenu_never_use_native : <%=isMobile==true?"true":"false"%>
};