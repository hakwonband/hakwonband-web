		...
		$.ajax({
			...
			success: function(data) {
				if(data) {
					...
					if(data.colData != null && data.colData.user_no != null && data.colData.user_no != 'undefined') {
						if(confirm(data.colData.user_id + "입니다. 등원 하시겠습니까?")) {
...
<body>
	...
	<table>
		<tr>
			...
			<td>
				<input type="button" onclick="checkCodeFun()" value="등원">
			</td>
		</tr>
	</table>
	</form>
