package hakwonband.hakwon.common.constant;
...
public class HakwonConstant {
	...
	public static class Api {
		public static final String JUSO_HOST = CommonConfig.getString("api/juso/host");
	...
	public static class PageScale {
		...
		public static final int TEACHER_REQ			= 20;	// 학원내 선생님 목록 요청
		public static final int CLASS_REQ			= 20;	// 학원내 반 목록 요청
		public static final int MESSAGE_REQ			= 20;	// 메세지 요청
		public static final int NOTICE_REQ			= 15;	// 공지사항 요청
	...
	public static class Sns {
		 ...
		 * 카카오톡
		 */
		public static final String KAKAO = CommonConfig.getString("sns/kakao");
	}
	...
	public static String getConstantJson() {
		try {
			...
			apiMap.put("JUSO_HOST", Api.JUSO_HOST);
